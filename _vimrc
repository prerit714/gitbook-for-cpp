...
" A function to set gui font size
...
" variable to disable italic fonts
let g:dracula_italic = 0

" Setting keymaps to the bottom
nnoremap <C-h> <C-w>h
nnoremap <C-j> <C-w>j
nnoremap <C-k> <C-w>k
nnoremap <C-l> <C-w>l
...
" Compile and run cpp commands in build mode
